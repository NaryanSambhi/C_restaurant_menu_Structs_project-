...
Naryan Sambhi: Coder/Co - leader: generated ideas for the struct/menu items, created the file input/output, created the safe get functions and getting input from user/print statements, defined the recipe types, added/changed comments, tested/fixed bugs, collaborated verbally with the menu items